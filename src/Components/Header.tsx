    ...
    return(
        <header className='w-screen h-[89px] border-b-1 flex justify-between py-4 px-10 border-slate-200 items-center'>
            ...
            {/*mostra um determinado botao se tiver ou não logado*/}
                {props.isLogin ? 
                <button className='w-[139px] h-12 flex gap-10 bg-emerald-900 rounded-[8px] py-3 px-10 font-inter font-[600] text-4 leading-[24.72px] text-center text-white'>Log out</button>
                :   
                <section className='w-[227px] h-12 flex gap-10 items-center' >
                    <a className='w-16 h-[25px] font-inter font-[500] text-[16px] leading-[24px] text-center text-slate-900'>Register</a>
                    <button className='w-[123px] h-12 flex gap-10 bg-emerald-900 rounded-[8px] py-3 px-10 font-inter font-[600] text-4 leading-[24.72px] text-center text-white'>Login</button>
                </section>
                }
