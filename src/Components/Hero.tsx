  ...
  return (
    <div className="flex justify-around w-full mr-[0]">
      <div className="w-[524px] h-[339px] mt-[206px] ml-[100px]">
        ...
        <button className="font-inter bg-emerald-950 text-[16px] text-white w-[157px] h-[48px] rounded-lg mt-[30px]
        hover:cursor-pointer hover:bg-emerald-800">Shop now</button>
      </div>
      <div>
