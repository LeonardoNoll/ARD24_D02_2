  ...
  return (
    <div className="flex gap-20 justify-between w-full">
      ...
      <div className="w-[524px] h-[339px] mt-[117px] ml-[112px] mr-[86px] flex gap-[24px] flex-col">
        <h1 className="font-play-display mb-[30px] font-[700] text-[64px] leading-[53px] text-emerald-900">
        ...
        <Link to={"/products"}>
          <button
            className="font-inter bg-emerald-900 text-[16px] text-white w-[157px] h-[48px] rounded-lg mt-[30px]
