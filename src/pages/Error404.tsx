      ...
      <>
        ...
        <section className="flex justify-center items-center min-h-screen">
            <div className="text-center p-8 shadow-lg rounded-lg max-w-lg">
                <h1 className="font-play-display text-6xl font-bold mb-20 text-emerald-900 ">ERROR 404</h1>
                <p className="font-play- display mb-10 mt-4 text-lg text-emerald-700">The page you are looking for does not exist!</p>
                <p className="mt-4">
